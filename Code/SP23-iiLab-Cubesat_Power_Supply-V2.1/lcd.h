...
{
	// 3.3V Bus
  tft.setCursor(Xoff,Yoff);tft.setTextColor(HX8357_CYAN); tft.setTextSize(3);
	...
	tft.println(outputs[0].power);

  // 5V Bus
  tft.setCursor(Xoff+Xoffset,Yoff);tft.setTextColor(HX8357_CYAN); tft.setTextSize(3);
  ...
  // 12V Bus
  tft.setCursor(Xoff+(Xoffset*2),Yoff);tft.setTextColor(HX8357_CYAN); tft.setTextSize(3);
