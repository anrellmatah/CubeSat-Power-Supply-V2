...
void loop()
{
	...
	collect_sens_data();
  Serial.println("completed collected_sens");
	refresh_lcd();
  Serial.println("completed refresh");
/*	#ifdef LOG_SERIAL
...
*/
	lcd_button_print();
  Serial.println("completed lcd_button");
/*	#ifdef ENABLE_TOUCH
		touch_query();
	#endif
*/
	send_data_sd();
  Serial.println("completed send_data");
